    ...
    <main class="flex items-center justify-center h-screen">
        ...
        <form method="POST" id="formAlumno" action="{{ route('students.store') }}" class="bg-white rounded-lg p-8 w-96 space-y-4 shadow-md">
            ...
            <div class="flex justify-center gap-x-5">
                <a href="/students" class="bg-gray-300 text-gray-800 px-4 py-2 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-opacity-50" @click="showModal = false">Cancelar</a>
